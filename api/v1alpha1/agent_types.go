...
type AgentNames string

const (
	Smith    AgentNames = "Smith"
	Brown    AgentNames = "Brown"
	Jones    AgentNames = "Jones"
	Jackson  AgentNames = "Jackson"
	Johnson  AgentNames = "Johnson"
	Thompson AgentNames = "Thompson"
)

// AgentSpec defines the desired state of Agent
type AgentSpec struct {
	Names []AgentNames `json:"names"`
}

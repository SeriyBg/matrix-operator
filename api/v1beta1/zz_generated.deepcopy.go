...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SingleAgent) DeepCopyInto(out *SingleAgent) {
	*out = *in
	if in.Health != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SingleAgent.
func (in *SingleAgent) DeepCopy() *SingleAgent {
	if in == nil {
		return nil
	}
	out := new(SingleAgent)
